...
[4. 컨셉 및 대표이미지 기반 작품묘사](#컨셉-및-대표이미지-기반-작품묘사)
...
- ### 시작화면에서는 설정화면, 엔딩보기, 불러오기 버튼 3개가 있다.
...
- ### 조작방식은 키보드의 WASD로 움직이며 마우스 왼쪽버튼으로 조사 및 아이템을 사용할 수 있다.
- ### 문제의 정답은 키보드로 입력할 수 있다.
- ### 아이템 사용은 아이템 창에서 사용할 수 있다.
- ### 조사하기는 아이템이나 문제가 있는곳에서 마우스 왼쪽버튼을 클릭해 할 수 있다.
- ### 푼 자물쇠는 더이상 사용이 불가능하며 사라진다.
- ### 게임을 종료할 때 게임화면에서 esc를 누른 후 저장하기를 통해 저장할 수 있다.
